...
// Check capability — supports dynamic roles; admin and super_admin always pass
...
module.exports = { authenticate, requireRole, requireCapability, requireSuperAdmin, JWT_SECRET };
